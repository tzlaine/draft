...
not a sequence container.\end{note}  Any sequence container used to
instantiate \tcode{flat_multimap} shall be no-throw swappable.
...
\tcode{value_comp()}; and finally erases the range \tange{ranges::unique(*this)}{end()};
...
finally erases the range \tange{ranges::unique(*this)}{end()}.
...
\tcode{uses_allocator_v<key_container_type, Alloc> &&
...
is not a sequence container.\end{note}  Any sequence container used to
instantiate \tcode{flat_multimap} shall be no-throw swappable.
