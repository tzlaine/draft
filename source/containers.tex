...
namespace std {
  ...
  template<class Key, class Compare, class Container>
    constexpr bool operator==(const flat_set<Key, Compare, Container>& x,
  ...
  template<class Key, class Compare, class Container>
    constexpr void swap(flat_set<Key, Compare, Container>& x,
  ...
  template<class Key, class Compare, class Container>
    constexpr bool operator==(const flat_multiset<Key, Compare, Container>& x,
  ...
  template<class Key, class Compare, class Container>
    constexpr void swap(flat_multiset<Key, Compare, Container>& x,
...
namespace std {
  ...
  public:
    ...
    template <class... Args>
      constexpr iterator try_emplace(const_iterator hint, const key_type& k,
                           Args&&... args);
    template <class... Args>
    ...
    template <class M>
      constexpr iterator insert_or_assign(const_iterator hint, const key_type& k,
                                          M&& obj);
    template <class M>
    ...
    constexpr void swap(flat_map& fm) noexcept;
    ...
    constexpr const key_container_type& keys() const      { return c.keys; }
    constexpr const mapped_container_type& values() const { return c.values; }
...
namespace std {
  ...
  public:
    ...
    constexpr flat_multimap(key_container_type key_cont, mapped_container_type mapped_cont,
      ...
      { }
    template <class Container>
      explicit constexpr flat_multimap(const Container& cont)
        : flat_multimap(cont.begin(), cont.end(), key_compare()) { }
    template <class Container, class Alloc>
      constexpr flat_multimap(const Container& cont, const Alloc& a)
    ...
    constexpr flat_multimap(sorted_equivalent_t, key_container_type key_cont,
      ...
      { }
    template <class Container>
      constexpr flat_multimap(sorted_equivalent_t s, const Container& cont)
        : flat_multimap(s, cont.begin(), cont.end(), key_compare()) { }
    template <class Container, class Alloc>
      constexpr flat_multimap(sorted_equivalent_t s, const Container& cont, const Alloc& a)
        : flat_multimap(s, cont.begin(), cont.end(), key_compare(), a) { }

    explicit constexpr flat_multimap(const key_compare& comp)
      : c(containers()), compare(comp) { }
    template <class Alloc>
      constexpr flat_multimap(const key_compare& comp, const Alloc& a);
    template <class Alloc>
      explicit constexpr flat_multimap(const Alloc& a)
    ...
    template <class Alloc>
      constexpr flat_multimap(flat_multimap&& m, const Alloc& a)
        : c{key_container_type(std::move(m.c.keys), a),
            mapped_container_type(std::move(m.c.values), a)}
        , compare{std::move(m.compare)}
      { }
    template<class Alloc>
      constexpr flat_multimap(const flat_multimap& m, const Alloc& a)
    ...
    constexpr void swap(flat_multimap& fm) noexcept;
    constexpr void clear() noexcept;
...
namespace std {
  ...
  public:
    ...
    explicit constexpr flat_set(container_type);
    template <class Alloc>
      constexpr flat_set(container_type cont, const Alloc& a)
        : flat_set(container_type(std::move(key), a)) { }
    template <class Container>
      explicit constexpr flat_set(const Container& cont)
        : flat_set(cont.begin(), cont.end(), key_compare()) { }
    template <class Container, class Alloc>
      constexpr flat_set(const Container& cont, const Alloc& a)
    ...
    template <class Alloc>
      constexpr flat_set(sorted_unique_t s, container_type cont, const Alloc& a)
        : flat_set(s, key_container_type(std::move(key_cont), a)) { }
    template <class Container>
      constexpr flat_set(sorted_unique_t s, const Container& cont)
        : flat_set(s, cont.begin(), cont.end(), key_compare()) { }
    template <class Container, class Alloc>
      constexpr flat_set(sorted_unique_t s, const Container& cont, const Alloc& a)
        : flat_set(s, cont.begin(), cont.end(), key_compare(), a) { }

    explicit constexpr flat_set(const key_compare& comp)
      : c(container_type()), compare(comp) { }
    template <class Alloc>
      constexpr flat_set(const key_compare& comp, const Alloc&);
    template <class Alloc>
      explicit constexpr flat_set(const Alloc&) 
    ...
    template <class InputIterator, class Alloc>
      constexpr flat_set(sorted_unique_t, InputIterator first, InputIterator last,
                         const key_compare& comp, const Alloc&);
    template <class InputIterator, class Alloc>
      constexpr flat_set(sorted_unique_t s, InputIterator first, InputIterator last,
                         const Alloc& a)
        : flat_set(s, first, last, key_compare(), a) { }

    template <class Alloc>
      constexpr flat_set(flat_set&& m, const Alloc& a)
        : c{container_type(std::move(m.c), a)}
        , compare{std::move(m.compare)}
      { }
    template<class Alloc>
      constexpr flat_set(const flat_set& m, const Alloc& a)
        : c{container_type(m.c, a)}
        , compare{m.compare}
      { }

    constexpr flat_set(initializer_list<key_type>&& il,
                       const key_compare& comp = key_compare())
        : flat_set(il, comp) { }
    template <class Alloc>
      constexpr flat_set(initializer_list<key_type>&& il,
        ...
        : flat_set(il, comp, a) { }
    template <class Alloc>
      constexpr flat_set(initializer_list<key_type>&& il, const Alloc& a)
        : flat_set(il, key_compare(), a) { }

    constexpr flat_set(sorted_unique_t s, initializer_list<key_type>&& il,
                       const key_compare& comp = key_compare()) 
        : flat_set(s ,il, comp) { }
    template <class Alloc>
      constexpr flat_set(sorted_unique_t s, initializer_list<key_type>&& il,
    ...
    constexpr flat_set& operator=(initializer_list<key_type>);
    ...
    template <class InputIterator>
      constexpr void insert(sorted_unique_t, InputIterator first, InputIterator last);
    constexpr void insert(initializer_list<key_type>);
    constexpr void insert(sorted_unique_t, initializer_list<key_type>);
...
class flat_multiset {
  public:
    ...
    explicit constexpr flat_multiset(container_type cont);
    template <class Alloc>
      constexpr flat_multiset(container_type cont, const Alloc& a)
        : flat_multiset(container_type(std::move(key), a)) { }
    template <class Container>
      explicit constexpr flat_multiset(const Container& cont)
        : flat_multiset(cont.begin(), cont.end(), key_compare()) { }
    template <class Container, class Alloc>
      constexpr flat_multiset(const Container& cont, const Alloc& a)
        : flat_multiset(cont.begin(), cont.end(), key_compare(), a) { }

    constexpr flat_multiset(sorted_equivalent_t, container_type cont)
      : c(std::move(cont)), compare(key_compare()) { }
    template <class Alloc>
      constexpr flat_multiset(sorted_equivalent_t, container_type, const Alloc&)
        : flat_multiset(s, container_type(std::move(cont), a)) { }
    template <class Container>
      constexpr flat_multiset(sorted_equivalent_t s, const Container& cont)
        : flat_multiset(s, cont.begin(), cont.end(), key_compare()) { }
    template <class Container, class Alloc>
      constexpr flat_multiset(sorted_equivalent_t s, const Container& cont, const Alloc& a)
        : flat_multiset(s, cont.begin(), cont.end(), key_compare(), a) { }

    explicit constexpr flat_multiset(const key_compare& comp)
      : c(container_type()), compare(comp) { }
    template <class Alloc>
      constexpr flat_multiset(const key_compare& comp, const Alloc&);
    template <class Alloc>
      explicit constexpr flat_multiset(const Alloc& a)
    ...
    template <class InputIterator, class Alloc>
      constexpr flat_multiset(sorted_equivalent_t, InputIterator first, InputIterator last,
                              const key_compare& comp, const Alloc&);
    template <class InputIterator, class Alloc>
      constexpr flat_multiset(sorted_equivalent_t s, InputIterator first, InputIterator last,
                              const Alloc& a)
        : flat_multiset(s, first, last, key_compare(), a) { }

    template <class Alloc>
     constexpr flat_multiset(flat_multiset&& m, const Alloc& a)
       : c{container_type(std::move(m.c), a)}
       , compare{std::move(m.compare)}
     { }
   template<class Alloc>
     constexpr flat_multiset(const flat_multiset& m, const Alloc& a)
       : c{container_type(m.c, a)}
       , compare{m.compare}
     { }

    constexpr flat_multiset(initializer_list<key_type>&& il,
                            const key_compare& comp = key_compare())
    ...
    template <class Alloc>
      constexpr flat_multiset(initializer_list<key_type>&& il, const Alloc& a)
        : flat_multiset(il, key_compare(), a) { }

    constexpr flat_multiset(sorted_equivalent_t s, initializer_list<key_type>&& il,
                            const key_compare& comp = key_compare())
    ...
    constexpr flat_multiset& operator=(initializer_list<key_type>);
    ...
    template <class InputIterator>
      constexpr void insert(sorted_equivalent_t, InputIterator first, InputIterator last);
    constexpr void insert(initializer_list<key_type>);
    constexpr void insert(sorted_equivalent_t, initializer_list<key_type>);
    ...
    constexpr void swap(flat_multiset& fms) noexcept;
    constexpr void clear() noexcept;
