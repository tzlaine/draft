...
namespace std {
  ...
  template<class Key, class Compare, class Container>
    void swap(flat_set<Key, Compare, Container>& x,
              flat_set<Key, Compare, Container>& y) noexcept(noexcept(x.swap(y)));
  ...
  template<class Key, class Compare, class Container>
    void swap(flat_multiset<Key, Compare, Container>& x,
              flat_multiset<Key, Compare, Container>& y) noexcept(noexcept(x.swap(y)));
}
\end{codeblock}
\end{addedblock}
...
namespace std {
  ...
  public:
    ...
    void swap(flat_map& fm) noexcept(is_nothrow_swappable_v<KeyContainer> &&
                                     is_nothrow_swappable_v<MappedContainer> &&
                                     is_nothrow_swappable_v<Compare>);
    void clear() noexcept;
...
namespace std {
  ...
  public:
    ...
    void swap(flat_multimap& fm) noexcept(is_nothrow_swappable_v<KeyContainer> &&
                                          is_nothrow_swappable_v<MappedContainer> &&
                                          is_nothrow_swappable_v<Compare>);
    void clear() noexcept;
...
namespace std {
  ...
  public:
    ...
    void swap(flat_set& fs) noexcept(is_nothrow_swappable_v<KeyContainer> &&
                                     is_nothrow_swappable_v<Compare>);
    void clear() noexcept;
...
template<class Key, class Compare, class KeyContainer>
  void swap(flat_set<Key, Compare, KeyContainer>& x,
            flat_set<Key, Compare, KeyContainer>& y) noexcept(noexcept(x.swap(y)));
\end{itemdecl}
...
class flat_multiset {
  public:
   ...
   template<class Alloc>
    ...
    void swap(flat_multiset& fms) noexcept(is_nothrow_swappable_v<KeyContainer> &&
                                           is_nothrow_swappable_v<Compare>);
    void clear() noexcept;
...
template<class Key, class Compare, class KeyContainer>
  void swap(flat_multiset<Key, Compare, KeyContainer>& x,
            flat_multiset<Key, Compare, KeyContainer>& y) noexcept(noexcept(x.swap(y)));
\end{itemdecl}
